...
export default function EditProfile() {
  const { id } = useParams();
  const websiteURL = `https://e-business-card-nu.vercel.app/profileView/${id}`;
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://e-business-card-nu.vercel.app/product/getProfile/${id}`, {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const updateProfileResponse = await axios.patch(
        `https://e-business-card-nu.vercel.app/product/updateProfile/${id}`,
        {
          username,
          title,
          companyname,
      ...
      if (updateProfileResponse.data.status) {
        ...
        const updateQRCodeResponse = await axios.patch(
          "https://e-business-card-nu.vercel.app/product/qrcodes",
          {
            imageData,
            userId: id,
            username,
