...
export default function AllProfile() {
  ...
  const handleDelete = (id) => {
    axios
      .delete(`https://e-business-card-nu.vercel.app/product/deleteProfile/${id}`)
      .then((res) => {
        console.log(res);
  ...
  const handleDeleteWork = (id) => {
    axios
      .delete(`\https://e-business-card-nu.vercel.app/product/deleteWork/${id}`)
      .then((res) => {
        console.log(res);
        window.location.reload();
      })
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("\https://e-business-card-nu.vercel.app/product/getAllProfiles", { withCredentials: true });
        ...
        for (let profile of fetchedProfiles) {
          const worksResponse = await axios.get(`https://e-business-card-nu.vercel.app/product/getwork/${profile._id}`, { withCredentials: true });
